...
export default function ProfileEditModal({ user, onClose, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
      <div className="w-full max-w-lg rounded-3xl bg-white p-8 text-[#1c1b1f] shadow-[0_30px_60px_rgba(0,0,0,0.35)]">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.25em] text-[#ff6f59]">
              Profile
            </p>
            <h2 className="mt-2 text-2xl font-semibold">Update your profile</h2>
            <p className="mt-2 text-sm text-[#6f6c73]">
              Change your name and photo anytime.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="mt-6 grid grid-cols-[auto_1fr] items-center gap-4 rounded-2xl bg-[#f6efe9] p-4">
